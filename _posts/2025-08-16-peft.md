...
> For a typical 4096x4096 attention matrix (~16.7M params), using LoRA with a rank of $r=8$ requires training only two matrices, totaling ~65k parameters. This represents a **reduction of over 99.6%**.
